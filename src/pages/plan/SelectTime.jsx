...
function SelectTime({
  ...
  return (
    <div className="w-full p-5 font-sans bg-white overflow-y-auto" style={{ minHeight: '600px', maxHeight: '600px' }}>
      <div>
      ...
      <div key={animationKey} className="mt-5"> {/* key 속성을 추가하여 애니메이션 효과 적용 */}
